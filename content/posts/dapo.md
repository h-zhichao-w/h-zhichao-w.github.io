...
在之前的文章中，我们简单讲了一下 DeepSeek 的 [GRPO]({{< relref "grpo.md" >}})，它通过“去 Critic”和“组内博弈”极大地降低了强化学习的门槛，引来了非常多的关注。但是在复现 DeepSeek-R1 时，有些人就发现朴素的 GRPO（Naive GRPO）存在一些“小问题”，导致其在 AIME 上的得分只能停留在 30 分左右，远低于 DeepSeek 的 47 分——
