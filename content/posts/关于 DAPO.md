...
$$
\begin{aligned}
\mathcal{J}\_{\text{DAPO}}(\theta)=& \quad\mathbb{E}\_{(q,a)\sim\mathcal{D},\{o\_{i}\}\_{i=1}^{G}\sim\pi\_{ \theta\_{\text{old}}}(\cdot|q)}\\\\
&\quad\Bigg[\frac{1}{\sum\_{i=1}^{G}|o\_{i}|}{\sum\_{i=1}^{G}\sum\_{t=1}^{|o\_{i}|}\min\Big(r\_{i,t}(\theta)\hat{A}\_{i,t},\ \text{clip}\Big(r\_{i,t}(\theta),1-\varepsilon\_{\text{low}},1+ \varepsilon\_{\text{high}}\Big)\hat{A}\_{i,t}\Big)}\Bigg],\\\\
\text{s.t.}&\quad 0<\Big|\{o\_{i}\mid\texttt{is\_equivalent}(a,o\_{i})\}\Big|<G.
\end{aligned}
$$
